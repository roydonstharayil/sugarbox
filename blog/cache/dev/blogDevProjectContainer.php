...
class blogDevProjectContainer extends Container {
    ...
    protected function getRouterService() {
        ...
        $instance = new $class($this->getRouting_LoaderService(), '/var/www/sugarbox/blog/config/routing.yml', array('cache_dir' => '/var/www/sugarbox/blog/cache/dev', 'debug' => false, 'matcher_cache_class' => 'blog'.'UrlMatcher', 'generator_cache_class' => 'blog'.'UrlGenerator'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService() {
        ...
        $instance = call_user_func(array('Doctrine\\DBAL\\DriverManager', 'getConnection'), array('driverClass' => 'Doctrine\\DBAL\\Driver\\pdo_mysql\\Driver', 'driverOptions' => array(), 'dbname' => 'todo', 'host' => 'localhost', 'user' => 'root', 'password' => 'admin'), $this->getDoctrine_Dbal_DefaultConnection_ConfigurationService(), $this->getDoctrine_Dbal_DefaultConnection_EventManagerService());
