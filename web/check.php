...
check(is_writable(__DIR__.'/../blog/cache'), sprintf('Checking that cache/ directory is writable'), 'Change the permissions of the blog/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../blog/logs'), sprintf('Checking that the logs/ directory is writable'), 'Change the permissions of the blog/logs/ directory so that the web server can write in it', true);
